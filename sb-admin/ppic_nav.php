...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item  -->
      <li class="nav-item">
        <a class="nav-link" href="#" id="openSalesLink">
  ...
  <script>
    $(document).ready(function() {
      ...
      // $("#dashboard").load("ppic_dashboard.php");

      // // Hide the "openSales" content initially
      // $("#openSales").hide();

      // Bind click event for Dashboard link
      $("#dashboardLink").click(function(e) {
        e.preventDefault();
        $("#openSales").hide(); // Hide openSales content
        $("#dashboard").show(); // Show dashboard content
        $("#dashboard").load("ppic_dashboard.php");
      });

      // Bind click event for Open Sales link
      $("#openSalesLink").click(function(e) {
        e.preventDefault();
        // $("#dashboard").hide(); // Hide dashboard content
        $("#openSales").show(); // Show openSales content
        $("#openSales").load("open_sales.php");
      });
    });
  </script>
</body>
